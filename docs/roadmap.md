...
- [ ] **Backfill F&G long-term + 5s10s history deeper** — currently 2025-05 / 2025-02; extend each per-year series as far back as the sources allow. Issue [#287](https://github.com/qte77/analyze-stock-kpi/issues/287), plan [`backfill-history`](plans/backfill-history.md).
